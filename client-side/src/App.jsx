...
function App() {
  ...
  const [chatMoreShow, setChatMoreShow] = useState('')
      ...
      <div className='app'>
        <div className="app_body">
          ...
          {isLoading ? <Box sx={style}>
            ...
            isAuthenticated ? <DataContext.Provider value={{ setChatMoreShow, chatMoreShow, setRefreshSidebar, refreshSidebar, setAllUsers, allUsers, setUserEmail, userEmail, setChatIconClicked, ischatIconClicked, setChatName, userName, roomID, setRoomID, chatName, setUserName, setOpenChat, privateChatData, setPrivateChatData, privateNewMsgRec, setPrivateNewMsgRec, privateNewMsg, setPrivateNewMsg }}>
              <><Sidebar />
                {openChat ? <Chat /> : null}
