...
export default function Chat() {
  ...
  const {chatMoreShow, setRefreshSidebar, setAllUsers, allUsers, userEmail, setChatIconClicked, userName, ischatIconClicked, roomID, chatName, setOpenChat, privateChatData, setPrivateChatData, setPrivateNewMsgRec, setPrivateNewMsg } = useContext(DataContext);
  ...
  const handleGroupDelete = async () => {
    try {
      ...
      const response = await axios.delete('http://localhost:32000/deleteGroup', {
        data: {
          roomID,
          userName
        }
      ...
      if (response.status === 200) {
        console.log('hittttttt group delete')
  ...
  useEffect(()=>{
    console.log('chatMoreShow:', chatMoreShow)
  },[chatMoreShow])
      ...
      <div className="chat_header">
        ...
        <div className="chat_headerRight">
          ...
          <ul class="dropdown-menu">
            { chatMoreShow === 'group' && <li><IconButton class="dropdown-item" onClick={handleAddMembers}>Add members</IconButton></li>}
            { chatMoreShow === 'group' && <li><IconButton class="dropdown-item" onClick={handleGroupDelete} >Delete & Exit Group</IconButton></li>}
